<template>
  ...
  <v-app id="inspire">
    ...
    >
      ...
      <div>
        JUNGFIT 이용약관, 개인정보 수집 및 이용, 위치정보 이용약관(선택), 프로모션 정보 수신(선택)에 모두 동의합니다.
      </div>
      <v-checkbox
        v-model="checkbox"
...
export default {
  ...
  data() {
    ...
    idRules: [
      ...
      v => !/[~!@#$%^&*()_+|<>?:{}]/.test(v) || '아이디에는 특수문자를 사용할 수 없습니다.',
    ],
    password: null,
    passwordRules: [
